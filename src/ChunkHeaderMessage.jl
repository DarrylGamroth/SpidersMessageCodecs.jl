...
struct ChunkHeaderMessageDecoder{T<:AbstractArray{UInt8}} <: ChunkHeaderMessage{T}
    ...
    function ChunkHeaderMessageDecoder(buffer::T, offset::Int64, position_ptr::Base.RefValue{Int64},
...
struct ChunkHeaderMessageEncoder{T<:AbstractArray{UInt8}} <: ChunkHeaderMessage{T}
    ...
    offset::Int64
    position_ptr::Base.RefValue{Int64}
    function ChunkHeaderMessageEncoder(buffer::T, offset::Int64, position_ptr::Base.RefValue{Int64}) where {T}
        position_ptr[] = offset + 72
        new{T}(buffer, offset, position_ptr)
    end
end

@inline function ChunkHeaderMessageDecoder(buffer::AbstractArray, offset::Int64=0;
...
@inline function ChunkHeaderMessageEncoder(buffer::AbstractArray, offset::Int64=0;
    position_ptr::Base.RefValue{Int64}=Ref(0),
    header::MessageHeader=MessageHeader(buffer, offset))
