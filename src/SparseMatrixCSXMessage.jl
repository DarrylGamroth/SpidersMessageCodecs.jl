...
@inline function SparseMatrixCSXMessageDecoder(buffer::AbstractArray, offset::Int64=0;
...
@inline function SparseMatrixCSXMessageEncoder(buffer::AbstractArray, offset::Int64=0;
    position_ptr::Base.RefValue{Int64}=Ref(0),
    header::MessageHeader=MessageHeader(buffer, offset))
