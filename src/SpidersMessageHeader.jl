...
export SpidersMessageHeader, SpidersMessageHeaderDecoder, SpidersMessageHeaderEncoder
...
Base.sizeof(m::SpidersMessageHeader) = sbe_encoded_length(m)
...
@inline function tag!(m::SpidersMessageHeaderEncoder, value::AbstractString)
    dest = tag!(m)
    fill!(dest, 0)
    copyto!(dest, value)
end
