...
struct TensorFragmentDataMessageDecoder{T<:AbstractArray{UInt8}} <: TensorFragmentDataMessage{T}
    ...
    function TensorFragmentDataMessageDecoder(buffer::T, offset::Int64, position_ptr::Base.RefValue{Int64},
...
struct TensorFragmentDataMessageEncoder{T<:AbstractArray{UInt8}} <: TensorFragmentDataMessage{T}
    ...
    offset::Int64
    position_ptr::Base.RefValue{Int64}
    function TensorFragmentDataMessageEncoder(buffer::T, offset::Int64, position_ptr::Base.RefValue{Int64}) where {T}
        position_ptr[] = offset + 72
        new{T}(buffer, offset, position_ptr)
    end
end

@inline function TensorFragmentDataMessageDecoder(buffer::AbstractArray, offset::Int64=0;
...
@inline function TensorFragmentDataMessageEncoder(buffer::AbstractArray, offset::Int64=0;
    position_ptr::Base.RefValue{Int64}=Ref(0),
    header::MessageHeader=MessageHeader(buffer, offset))
