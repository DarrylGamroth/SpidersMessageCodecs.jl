...
@inline function SparseVectorMessageDecoder(buffer::AbstractArray, offset::Int64=0;
...
@inline function SparseVectorMessageEncoder(buffer::AbstractArray, offset::Int64=0;
    position_ptr::Base.RefValue{Int64}=Ref(0),
    header::MessageHeader=MessageHeader(buffer, offset))
